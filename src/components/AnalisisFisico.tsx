            ...
            <div>
                ...
                <div className="InputAnalisis">
                    ...
                    <div className={validClass["pesoDefecto"].classStatus}>
                        <input className={validClass["pesoDefecto"].classStatus} step={0.1} type="number" id="pesoDefecto" value={defectWeight} onChange={(e)=>handleDefectWeight(e)}></input>
                        <p>El peso debe ser mayor a cero</p>
                    </div>
                    <button style={{display: "inline"}} onClick={handleAddDefect} >Agregar</button>
